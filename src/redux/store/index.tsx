...
const MigratedStorage = {
	...
	async setItem(key: any, value: any) {
		try {
			...
			console.log('Failed to set item');
		}
	},
...
const persistConfig = {
	...
	timeout: TIMEOUT,
	writeFailHandler: (error: any) => console.log('Error persisting data'), // Log error if saving state fails
};

//@ts-ignore
const pReducer = persistReducer(persistConfig, rootReducer);

export const store: any = createStore(pReducer);
