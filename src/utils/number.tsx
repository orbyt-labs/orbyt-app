 ...
 */
 ...
 import currencySymbols from './currency.json';
 ...
 const toSpecifiedDenomination = {
     WEI: (bigNumber: any) => bigNumber.times(BIG_NUMBER_WEI_MULTIPLIER).decimalPlaces(0),
     GWEI: (bigNumber: any) => bigNumber.times(BIG_NUMBER_GWEI_MULTIPLIER).decimalPlaces(9),
     ETH: (bigNumber: any) => bigNumber.times(BIG_NUMBER_ETH_MULTIPLIER).decimalPlaces(9),
 };
 const baseChange = {
  ...
  */
 export function BNToHex(value: any) {
  ...
  * @returns {string} - String containing the new number
  */
 export function fromTokenMinimalUnit(minimalInput: any, decimals: any) {
  ...
  */
 export function renderFromTokenMinimalUnit(tokenValue: any, decimals: any, decimalsToShow = 5) {
  ...
  * If value is less than 5 precision decimals will show '< 0.00001'
  */
 export function renderFiatAddition(transferFiat: any, feeFiat: any, currentCurrency: any, decimalsToShow = 5) {
  ...
  */
 export function fiatNumberToTokenMinimalUnit(fiat: any, conversionRate: any, exchangeRate: any, decimals: any) {
  ...
  */
 export function hexToBN(value: any) {
 ...
 export function renderToGwei(value: any, unit = 'ether') {
     const gwei: any = fromWei(value, unit) * 1000000000;
     //@ts-ignore
     let gweiFixed: any = parseFloat(Math.round(gwei));
  ...
  */
 export function weiToFiat(wei: any, conversionRate: any, currencyCode: any, decimalsToShow = 5) {
  ...
  * @returns {string} - Currency-formatted string
  */
 export function addCurrencySymbol(amount: any, currencyCode: any) {
     if (currencyCode === 'usd') {
  ...
  */
 export function weiToFiatNumber(wei: any, conversionRate: any, decimalsToShow: number = 5) {
     const base = Math.pow(10, decimalsToShow);
     const eth = fromWei(wei).toString();
     //@ts-ignore
     let value: number = parseFloat(Math.floor(eth * conversionRate * base) / base);
  ...
  * @returns {string} - Currency-formatted string
  */
 export function balanceToFiat(balance: any, conversionRate: any, exchangeRate: any, currencyCode: any) {
  ...
  * @returns {Number} - The converted balance
  */
 export function balanceToFiatNumber(balance: any, conversionRate: any, exchangeRate: any, decimalsToShow = 5) {
     const base: any = Math.pow(10, decimalsToShow);
     //@ts-ignore
     let fiatFixed: any = parseFloat(Math.floor(balance * conversionRate * exchangeRate * base) / base);
