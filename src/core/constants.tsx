...
export default {
	...
	HOMEPAGE_URL: 'https://orbyt-wallet.co.za/',
	SHORT_HOMEPAGE_URL: 'orbyt-wallet.co.za',
	...
	NOTIFICATION_NAMES: {
		accountsChanged: 'orbyt-wallet_accountsChanged',
		unlockStateChanged: 'orbyt-wallet_unlockStateChanged',
		chainChanged: 'orbyt-wallet_chainChanged',
	},
	FIAT_ORDERS: {
